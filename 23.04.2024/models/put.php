...
class Put
{
    ...
    public function update_salesDetails(
        ...
        mysqli_stmt_bind_param($stmt, "isssssiiiissssssiissisiiiii", $mobile_no, $customer_name, $customer_type, $location, $site_name, $product_name, $product_quantity, $total_amount, $paid_amount, $balance_amount, $payment_method, $payment_type, $gst_no, $vehicle_no, $vehicle_type, $driver_name, $fuel_liter, $fuel_amount, $date, $wages, $wages_amount, $other_expenses, $expenses_amount, $wages_total_amount, $rental_amount, $balance_amount1, $sales_id);
        $updateQuery = mysqli_stmt_execute($stmt);
    ...
    //update sales payment make payment

    public function update_salespaymentDetails(
        $sales_id,
        $paid_amount,
        $balance_amount
    ) {
        $update = "UPDATE sales SET paid_amount=?,balance_amount=? WHERE sales_id=?";
        ...
        mysqli_stmt_bind_param($stmt, "iii", $paid_amount, $balance_amount, $sales_id);
        $updateQuery = mysqli_stmt_execute($stmt);
