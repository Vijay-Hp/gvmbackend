...
class Delete
{
    ...
    //module:service
    public function delete_service($vehicleNo)
    {

        $deleteReq = "DELETE FROM service WHERE vehicle_no=?";
        $stmtDelete = mysqli_prepare($this->conn, $deleteReq);
        mysqli_stmt_bind_param($stmtDelete, 's', $vehicleNo);
        $resultDelete = mysqli_stmt_execute($stmtDelete);
    ...
    //module:Rental
    public function delete_rental($site_name)
    {

        $deleteReq = "DELETE FROM rental WHERE site_name=?";
        $stmtDelete = mysqli_prepare($this->conn, $deleteReq);
        mysqli_stmt_bind_param($stmtDelete, 's', $site_name);
        $resultDelete = mysqli_stmt_execute($stmtDelete);
